...
class HyperpayPlugin : FlutterPlugin, MethodCallHandler, ITransactionListener, ActivityAware,
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel =
            MethodChannel(flutterPluginBinding.binaryMessenger, "plugins.nyartech.com/hyperpay")
    ...
    private var cctConnection: CustomTabsServiceConnection =
                ...
                try {
                    ...
                    when (brand) {
                        ...
                        Brand.UNKNOWN -> result.error(
                            ...
                            val paymentParams: PaymentParams = TokenPaymentParams(
                                checkoutID,
                                token,
                                brand.name,
                                cvv
